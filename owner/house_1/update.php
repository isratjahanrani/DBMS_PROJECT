...
$id=$_GET ['updateid'];
$query ="SELECT `No_of_Flats`, `Flat Location`, `Number of Rooms`, `Washroom`, 
          ...
          <div class="details personal">
            ...
            <div class="fields">
              <div class="input-field">
                ...
                <input type="number" placeholder=" Enter the Number of Flats" name="No_of_Flats" value =<?php  echo "$No_of_Flats";?> required />
              </div>
