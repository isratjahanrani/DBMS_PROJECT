...
if (!isset($_FILES["image"]) || $_FILES["image"]["error"] == 4) {
  ...
  if ( !in_array($imageExtension, $validImageExtension) ){
    ...
    $id=random_num(20);
    $query = "insert into house(id,`House Name`,`House no. & Road No.`,Address,`Flat Location`,`Number of Rooms`,Washroom,Balcony,Kitchen,`Drawing / Dinning room`,`Security (CCTV)`,Guard,Lift,`Service Charge`,Pics,`Price Range`) values('$id','$House_Name','$House_Road_No','$Address','$Flat_Location','$Number_of_Rooms','$Washroom','$Balcony','$Kitchen','$Drawing_Dinning','$CCTV','$Guard','$Lift','$Service_Charge','$newImageName','$Price_Range')";
		mysqli_query($conn,$query);
    echo
    "
    <script>
      alert('Successfully Added');
      document.location.href = 'doo1.php';
    </script>
    ";
  }
}	
...
<html lang="en">
          ...
          <div class="details personal">
            ...
            <div class="fields">
              <div class="input-field">
                ...
                <input type="text" placeholder=" Enter the Number of Flats" name="House_Name" required />
              </div>
  ...
  <div class="card">
    ...
    <div class="drop_box">
      ...
      <input type="file" accept=".jpg, .jpeg, .png" id="fileID" name="image" style="display:none;">
