...
if(!empty($House_Road_No) && !empty($Address))
    ...
    // $O_id= random_num(20);
    $id=random_num(20);
    $query = "insert into house(id,`House Name`,`House no. & Road No.`,Address,`Flat Location`,`Number of Rooms`,Washroom,Balcony,Kitchen,`Drawing / Dinning room`,`Security (CCTV)`,Guard,Lift,`Service Charge`,Pics,`Price Range`) values('$id','$House_Name','$House_Road_No','$Address','$Flat_Location','$Number_of_Rooms','$Washroom','$Balcony','$Kitchen','$Drawing_Dinning','$CCTV','$Guard','$Lift','$Service_Charge','$Pics','$Price_Range')";
