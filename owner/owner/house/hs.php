          ...
          <div class="card-wrapper main-card">
            <a class="card cardItemjs" onclick="openModal()">
              ...
              <div class="card-info">
                ...
                <div class="card-text small"><?php  echo  $row["House no. & Road No."] ;?></div>
                <div class="card-text small">
                  Starts from:
                  <span class="card-price"><?php  echo  $row["Price Range"] ;?></span>
                </div>
              </div>
            </a>
          </div>
          ...
          <div class="card-wrapper main-card">
            <a class="card cardItemjs" onclick="openModal()">
              ...
              <div class="card-info">
                ...
                <div class="card-text small">
                  Starts from:
                  <span class="card-price"> Tk 1000</span>
                </div>
              </div>
            </a>
          </div>
      ...
      <div class="main-modal">
        <div class="modal-left">
          ...
          <div class="modal-info-header">
            <div class="left-side">
              <h1 class="modalHeader-js"><?php  echo  $row["id"] ;?> </h1>
              <p><?php  echo  $row["House no. & Road No."] ;?></p>
            </div>
            <div class="right-side">
              Starts from:
              <span class="amount"><?php  echo  $row["Price Range"] ;?></span>
            </div>
          </div>
          <div class="info-bar">
            <div class="info-wrapper">
              ...
              <span><?php  echo  $row["Number of Rooms"] ;?>Bedrooms</span>
            </div>
            <div class="info-wrapper">
              <div class="info-icon">
                <svg
              ...
              <span><?php  echo  $row["Balcony"] ;?> Belcony</span>
            </div>
            <div class="info-wrapper">
              <div class="info-icon">
                <svg
              ...
              <span><?php  echo  $row["Kitchen"] ;?> Kitchen</span>
            </div>
            <div class="info-wrapper">
              <div class="info-icon">
                <svg
            ...
            <div class="info-wrapper">
              ...
              <span>Floor no <?php  echo  $row["Flat Location"] ;?></span>
            </div>
            <div class="info-wrapper">
              <div class="info-icon">
                <svg
              ...
              <span> Security <?php  echo  $row["Guard"] ;?></span>
            </div>
          </div>
